...
<div class="row">
	<div class="col-md-3">
		...
		<a href="${detailPage}">
		<img id="park-img" style="height: 20vw; width:auto" class="img-responsive center-block" src="${parkImage}" alt="${park.name}"/></a>
	</div>
	<div class="col-md-9">
		<a href="${detailPage}">
		<h1 id="park-name" class="francois-font"><c:out value="${park.name}"/></h1></a><br>
